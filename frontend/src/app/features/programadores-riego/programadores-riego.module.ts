...
import { ProgramadoresRiegoRoutingModule } from './programadores-riego-routing.module';
...
@NgModule({
  declarations: [
    ProgramadorRiegoListaComponent,
    ProgramadorRiegoFormularioComponent
  ],
  imports: [
    CommonModule,
    ProgramadoresRiegoRoutingModule,
    MatCardModule,
    MatTableModule,
    MatPaginatorModule,
    MatSortModule,
...
export class ProgramadoresRiegoModule { }
